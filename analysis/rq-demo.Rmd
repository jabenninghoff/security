...
**Note:** the functions and report in the demo below are currently being migrated to a new project,
[quantrr](https://jabenninghoff.github.io/quantrr/), that will support both experienced R users
with a package / RStudio installation, and novice users with a standalone installation. (I wanted
