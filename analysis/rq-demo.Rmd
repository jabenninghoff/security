...
validate_estimates <- local({
  validate_rules <- validator(
    ...
    expert_not_blank = nzchar(expert),
...
#|   - "Histogram combining all risks using different colors."
forecast |>
  ggplot(aes(losses)) +
...
#| warning: false
#| fig-alt:
#|   - "A histogram showing number of losses by dollar value on a log10 scale. The curve is roughly
#|     normally shaped with a mean near $1M."
#|   - "A histogram showing number of losses by dollar value on a log10 scale. The curve is roughly
#|     normally shaped with a mean near $100K."
