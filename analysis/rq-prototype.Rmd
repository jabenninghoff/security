...
```{r}
#| label: outage_freq
#| fig-alt: "A histogram showing the count of event occurences for whole numbers from 0 to 10."
...
Drawing from the
[IRIS 2022](https://www.cyentia.com/wp-content/uploads/2026/03/IRIS-2022_Cyentia.pdf) report, the
loss magnitude of a cybersecurity breach follows a log-normal distribution with a mean ($\mu$) of
12.56 and a standard deviation ($\sigma$) of 3.07, which gives a log-transformed lognormal curve of:

```{r}
#| label: breach_impact_dist
#| fig-alt: "A normal curve with a mean of 12.56."
...
```{r}
#| label: outage_duration_dist
#| fig-alt: "A histogram showing the count of event occurences for whole numbers from 0 to 80."
...
consensus_params <- consensus |>
  mutate(as_tibble(lnorm_param(p05 = .data$p05, p95 = .data$p95, p50 = .data$p50)))
...
```{r}
#| label: combined_hist
#| fig-alt: "Histogram combining all risks using different colors."
forecast |>
...
```{r}
#| label: risk_le
#| fig-alt: "Stacked empirical cumulative distribution functions for each risk."
risk_le <- forecast |>
  ggplot(aes(losses)) +
  facet_grid(vars(risk)) +
...
#| fig-alt: "Interactive stacked empirical cumulative distribution functions for each risk."
...
#| label: risk_le_log
#| fig-alt:
#|   - "Plot showing likelihood of experiencing a loss exceeding a given dollar value by risk."
#|   - "Interactive plot showing likelihood of experiencing a loss exceeding a given dollar value
#|     by risk."
...
```{r}
#| label: combined_le
#| fig-alt: "Empirical cumulative distribution function for combined risk."
...
#| fig-alt: "Interactive empirical cumulative distribution function for combined risk."
...
```{r}
#| label: combined_le_log
#| fig-alt:
#|   - "Plot showing likelihood of experiencing a combined loss exceeding a given dollar value."
#|   - "Interactive plot showing likelihood of experiencing a combined loss exceeding a given dollar
#|     value."
