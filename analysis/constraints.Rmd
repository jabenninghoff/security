...
```{r}
#| label: background
#| fig-alt: "A normal curve of height 0.4 and mean of 0 with the area under the curve between -2
#|          and -3 colored red."
xmin <- -5
xmax <- 5
...
#| label: good
#| fig-alt: "A normal curve of height 0.4 and mean of 0 with the area under the curve between -2
#|          and -3 colored red and the area under the curve between 1 and 3 colored green."
...
```{r}
#| label: constrained
#| fig-alt: "A taller normal curve of height just under 0.6 and mean of 0 with the area under the
#|          curve between -2 and -3 colored red and the area under the curve between 1 and 3 colored
#|          green. The colored areas are smaller than in the previous plot."
...
```{r}
#| label: overlay
#| fig-alt: "A plot showing both the first normal curve overlaid with the taller, narrower normal
#|          curve."
background +
  bad +
  good +
...
```{r}
#| label: performance
#| fig-alt: "A normal curve of height 0.4 and mean of 1 with the area under the curve between -2
#|          and -3 colored red."
...
```{r}
#| label: overlay_perf
#| fig-alt: "A plot showing both the first normal curve with a mean of 0 overlaid with the
#|          right-shifted normal curve with a mean of 1."
background +
  bad +
  improved +
  baseline +
...
```{r}
#| label: overlay_all
#| fig-alt: "A plot showing the first normal curve overlaid with the taller, narrower normal curve
#|          and the right-shifted normal curve."
background +
  bad +
  improved +
  baseline +
...
```{r}
#| label: questionnaire
#| fig-alt: "A bar plot comparing questionnaire length in 2020 and 2023. Questionnaires of length
#|          101-400 questions increased and other lengths decreased between 2020 and 2023."
